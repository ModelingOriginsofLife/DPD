...
void SDL_putPixel(SDL_Surface*, int x, int y, Uint32 clr);
...
#define SDL_drawRect_Alpha(surf, x1, y1, x2, y2, clr, alpha) \
    {\
       SDL_drawLine_Alpha((surf), (x1),(y1),(x1),(y2), (clr), (alpha)); \
       SDL_drawLine_Alpha((surf), (x2),(y1),(x2),(y2), (clr), (alpha)); \
       SDL_drawLine_Alpha((surf), (x1),(y1),(x2),(y1), (clr), (alpha)); \
       SDL_drawLine_Alpha((surf), (x1),(y2),(x2),(y2), (clr), (alpha)); \
    }
